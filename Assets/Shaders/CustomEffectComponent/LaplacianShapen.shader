    ...
    SubShader {
        ...
        Pass {
            ...
            v2f vert(a2v input) {
                ...
                output.positionSS = ComputeScreenPos(positionCS);
            ...
            float4 frag(v2f input) : SV_Target {
                ...
                float4 LaplacianBasic = c4 - (c1 + c3 + c5 + c7 - 4 * c4) * _Intensity;
                float4 LaplacianEnhanced = c4 - (c0 + c1 + c2 + c3 + c5 + c6 + c7 + c8 - 8 * c4) * _Intensity;

                return LaplacianEnhanced ;
            }
