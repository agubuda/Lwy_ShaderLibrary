    ...
    SubShader
    {
        ...
        pass
        {
            ...
            CBUFFER_START(UnityPerMaterial)
                ...
                float4 _InsideColor, _OutsideColor;
            ...
            half4 frag(v2f input, bool vf : SV_ISFRONTFACE) : SV_TARGET
            {
                ...
                float liquidHorizont = (input.positionWS.y - input.positionOS.y) * 0.5 + 0.5;

                float liquid = 1 - smoothstep(_Min, _Min + _liquidEdge, liquidHorizont) ;
                // float liquid =   1 - smoothstep(_Min, _Min + _liquidEdge ,liquidHorizont);
                ...
                // return half4(_BaseColor.rgb * halfLambert, saturate(liquid - 0.1)) ;
                // return vf > 0 ? half4(_InsideColor.rgb   ,_InsideColor.a * liquid) : half4(_OutsideColor.rgb  ,_OutsideColor.a *liquid );
                // return half4(difusse.rgb, liquid);
                return half4(liquid,liquid,liquid,liquid);
            }
